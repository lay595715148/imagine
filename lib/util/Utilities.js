...
Utilities.isException = function(o) {
    if(Utilities.isError(o)) {
        ...
        return Utilities._isException(o.constructor);
    } else {
        return false;
    }
};
 ...
 * @api private
 */
Utilities._isException = function(constructor) {
    if(constructor.name == 'Exception') {
        return true;
    } else if(!Utilities.isUndefined(constructor.super_)) {
        return Utilities._isException(constructor.super_);
    } else {
        return false;
    }
};
